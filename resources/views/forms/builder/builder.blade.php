                ...
                >
                    ...
                    >
                        @php
                            ...
                            $wireClickActionArguments['afterItem'] = $itemKey;

                            $wireClickActionArguments = \Illuminate\Support\Js::from($wireClickActionArguments);

                            $wireClickAction = "mountAction('{$addBetweenAction(['afterItem' => $itemKey])->getName()}', {$wireClickActionArguments}, { schemaComponent: '{$key}' })";
                        @endphp
                        <x-filament::button
                            :icon="$blockIcon"
